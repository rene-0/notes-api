<?php
	...
	class Router
	{
		...
		private $prefix = array();//Prefixo da url, por exemplo sysadm é o prefixo de sysadm/home/index
		...
		static function getBaseUrl()
		{
			...
			$link .= "://{$_SERVER['HTTP_HOST']}/receitasOn/public/";//caminho para o front controller
			return $link;
		}
